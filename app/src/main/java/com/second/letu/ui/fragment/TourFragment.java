...
import com.second.letu.adapter.TourListViewAdapter;
...
public class TourFragment extends BaseFragment {
    ...
    private static final String keyWord = "景点";//关键词
    private static final String ctgr = "风景名胜";//领域
    private int currentPage = 0;//当前页数
    private TourListViewAdapter mMyListViewAdapter;
    ...
    public View getSuccessView() {
        ...
        mMyListViewAdapter = new TourListViewAdapter(mDataFromModel, TourFragment.this);
