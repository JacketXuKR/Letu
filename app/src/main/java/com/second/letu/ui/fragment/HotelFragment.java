...
import com.second.letu.adapter.HotelListViewAdapter;
...
public class HotelFragment extends BaseFragment {
    ...
    private static final String keyWord = "酒店";//关键词
    private static final String ctgr = "住宿服务|商务住宅";//领域
    private int currentPage = 0;//当前页数
    private HotelListViewAdapter mMyListViewAdapter;
    ...
    public View getSuccessView() {
        ...
        mMyListViewAdapter = new HotelListViewAdapter(mDataFromModel, HotelFragment.this);
