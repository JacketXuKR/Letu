...
public class WalkRouteDetailActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public WalkRouteDetailActivity_ViewBinding(WalkRouteDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public WalkRouteDetailActivity_ViewBinding(final WalkRouteDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WalkRouteDetailActivity target = this.target;
